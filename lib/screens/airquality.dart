...
import 'package:ekotrack/constants/aqi.dart';
import 'package:ekotrack/service/aqi_api.dart';
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Text(
              "Check the air quality of the city you want to go to",
                      ...
                      if (controller.text.isNotEmpty &&
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                "Error loading for the city indicated.",
                              ),
                            ),
                          );
                        }
